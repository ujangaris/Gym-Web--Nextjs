    ...
    <section className="pt-8 pb-14 lg:pt-16 lg:pb-28" id="about">
      <div className="container mx-auto">
        ...
        <div className="flex flex-col items-center gap-2 mb-8">
          ...
          <p className="max-w-[600px] mx-auto text-center">Lorem ipsum dolor sit amet consectetur adipisicing elit. Quas, illo facilis recusandae earum saepe minus nostrum quo similique rerum dolore?</p>
        </div>
        {/* featured items */}
